...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.update_frame = self.create_frame(
            self.centralWidget, 0, 0, 1920, 1080, "", "update_frame"
        )

        # Set the frame background to white
        self.update_frame.setStyleSheet("background-color: #dceaf7;")

        # Create a vertical layout for the update frame
        update_layout = QtWidgets.QVBoxLayout(self.update_frame)

        # Add a QLabel for the update message
        self.update_header = QtWidgets.QLabel()
        self.update_header.setText("Over-the-Air Update")
        self.update_header.setAlignment(QtCore.Qt.AlignCenter)  # Center align the text
        self.update_header.setStyleSheet("font-size: 50px; font-weight: bold;")  # Double the font size (16px * 2)


        self.update_message = QtWidgets.QLabel()
        self.update_message.setText("An over-the-air update has been installed and the software has\nbeen updated to version 1.0.2.\n\nThis update includes bug fixes, security improvements, and\ndesign updates.")
        self.update_message.setStyleSheet("font-size: 50px;")  # Double the font size (16px * 2)

        # Add a QPushButton for "OK"
        self.ok_button = QtWidgets.QPushButton()
        self.ok_button.setText("OK")
        self.ok_button.setFixedSize(400, 100)  # Set size to double the button dimensions
        self.ok_button.setStyleSheet("font-size: 55px; background-color: white;")

        # Add widgets to the layout
        update_layout.addStretch()  # Add stretch to push content to the center
        update_layout.addWidget(self.update_header, alignment=QtCore.Qt.AlignCenter)
        update_layout.addSpacing(50)
        update_layout.addWidget(self.update_message, alignment=QtCore.Qt.AlignCenter)
        update_layout.addSpacing(50)  # Add spacing between text and button
        update_layout.addWidget(self.ok_button, alignment=QtCore.Qt.AlignCenter)
        update_layout.addStretch()  # Add stretch to push content to the center

        # Show the frame at startup
        self.update_frame.show()
        self.update_frame.move(0, 0)
        self.update_frame.resize(1920,1080)
        self.update_frame.raise_()

        # Create the version label frame
        self.version_frame = self.create_frame(self.centralWidget, 935, 10, 100, 40, "", "version_frame")
        ...
        #self.light_frame = self.create_frame(self.centralWidget, 670, 410, 611, 231, "background-color: orange;", "light_frame")
        #self.light_frame.setStyleSheet("QFrame {"
        ...
        #self.wiper_frame = self.create_frame(self.centralWidget, 670, 410, 611, 231, "background-color: purple;",
        #                                     "wiper_frame")
        #self.wiper_frame.setStyleSheet("QFrame {"
        #                                "background-image: url('C:/Users/D-Lab/Documents/TouchScreenInterface/icons/map_2.png');"
        #                                "background-position: center;"
        #                                "}"
        #                                )
        ...
        self.version_label = QtWidgets.QLabel("Software v1.0.2", self.climate_frame)
        ...
        self.fan_background_frame.setStyleSheet("background-color: transparent;")  # Solid white background
    ...
    def add_h5_light(self, parent_layout, frame):
        ...
        self.h5_light_button_max.setIcon(QIcon('C:/Users/D-Lab/Documents/TouchScreenInterface/icons/rear_defrost_white.PNG'))
    ...
    def add_horizontal_sublayout_2(self, parent_layout, frame):
        ...
        self.horizontalSubLayout_2.setSpacing(2)  # Set 2-pixel spacing between all items in this layout
        ...
        self.h2_climate_button_spacer_2.setFixedSize(300, 125)
        ...
        #self.fan_logo_button.setEnabled(False)
        ...
        self.horizontalSubLayout_2.addLayout(logo_and_minus_layout)
        ...
        self.horizontalSubLayout_2.addWidget(self.h3_climate_button_spacer_minus)
        ...
        self.horizontalSubLayout_2.addLayout(bars_with_empty_label_layout)
        ...
        self.horizontalSubLayout_2.addWidget(self.h3_climate_button_spacer_plus)
        self.horizontalSubLayout_2.addWidget(self.h3_climate_button_plus)
    ...
    def add_horizontal_sublayout_3(self, parent_layout, frame):
        ...
        self.h3_climate_button_spacer_1.setFixedSize(50, 125)  # set size
        ...
        self.horizontalSubLayout_3.addLayout(label_slider_layout)
        ...
        self.h3_climate_button_spacer_2.setFixedSize(143, 125)  # set size
    ...
    def add_h5_fan(self, parent_layout, frame):
        ...
        self.h5_fan_button_max.setIcon(QIcon('C:/Users/D-Lab/Documents/TouchScreenInterface/icons/rear_defrost_white.PNG'))
    ...
    def initVideoPlayer(self):
        ...
        video_html = """
               ...
               <iframe width="100%" height="100%" 
                   src="https://www.youtube.com/embed/g5mFRpA_7vc?autoplay=1&mute=1&loop=1&playlist=g5mFRpA_7vc" 
                   frameborder="0" 
