...
from version1_light_high import Ui_MainWindow
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # misc. buttons
        self.button_seat_1.clicked.connect(lambda: self.highlight_button(self.button_seat_1))
        self.button_seat_2.clicked.connect(lambda: self.highlight_button(self.button_seat_2))
        self.h5_light_button_seat_1.clicked.connect(lambda: self.highlight_button(self.h5_light_button_seat_1))
        self.h5_light_button_seat_2.clicked.connect(lambda: self.highlight_button(self.h5_light_button_seat_2))
        self.h5_wiper_button_seat_1.clicked.connect(lambda: self.highlight_button(self.h5_wiper_button_seat_1))
        self.h5_wiper_button_seat_2.clicked.connect(lambda: self.highlight_button(self.h5_wiper_button_seat_2))
        self.h5_home_button_seat_1.clicked.connect(lambda: self.highlight_button(self.h5_home_button_seat_1))
        self.h5_home_button_seat_2.clicked.connect(lambda: self.highlight_button(self.h5_home_button_seat_2))
        ...
        self.h3_climate_button_minus.clicked.connect(lambda: self.highlight_button(self.h3_climate_button_bar_1))
        ...
        # LOGS
        # self.miss.clicked.connect(lambda: self.log_button_click("Missed"))  # Log clicks
        ...
        self.h5_home_button_max.clicked.connect(lambda: self.log_button_click("Max Defrost"))
        ...
        self.h5_fan_button_max.clicked.connect(lambda: self.log_button_click("Max Defrost"))
        ...
        self.h4_light_button_light_off.clicked.connect(lambda: self.log_button_click("Turn Lights Off"))
        self.h4_light_button_blinker.clicked.connect(lambda: self.log_button_click("Blinker"))
        self.h4_light_button_light.clicked.connect(lambda: self.log_button_click("Light Options"))
        self.h4_light_button_beam.clicked.connect(lambda: self.log_button_click("High Beam"))
        self.h4_light_button_beam_off.clicked.connect(lambda: self.log_button_click("Turn High Beam Off"))
        ...
        self.h5_light_button_max.clicked.connect(lambda: self.log_button_click("Max Defrost"))
        ...
        self.h4_wiper_button_wiper_off.clicked.connect(lambda: self.log_button_click("Turn Wipers Off"))
        ...
        self.h5_wiper_button_max.clicked.connect(lambda: self.log_button_click("Max Defrost"))
        ...
        self.button_max.clicked.connect(lambda: self.log_button_click("Max Defrost"))
        ...
        # climate frame buttons
        self.h2_climate_button_off.clicked.connect(lambda: self.log_button_click("Turn Climate Off"))
        ...
        self.h3_climate_button_stickman_4.clicked.connect(lambda: self.log_button_click("Vent to Feet and Defrost"))
        self.h3_climate_button_defrost.clicked.connect(lambda: self.log_button_click("Windshield Defrost"))

        self.h4_climate_button_airflow_1.clicked.connect(lambda: self.log_button_click("Low Airflow"))
        self.h4_climate_button_airflow_2.clicked.connect(lambda: self.log_button_click("High Airflow"))
        ...
        self.h4_climate_button_auto.clicked.connect(lambda: self.log_button_click("Automatic Climate Control"))
    ...
    def highlight_button(self, clicked_button):
        ...
        buttons = [ self.button_left_arrow, self.button_right_arrow,
                    ...
                    self.button_settings,self.button_seat_1,self.button_seat_2,
                    # light
                    ...
                    self.h5_light_button_max,self.h5_light_button_seat_1,self.h5_light_button_seat_2,
                    # wiper
                    ...
                    self.h5_wiper_button_max,self.h5_wiper_button_seat_1,self.h5_wiper_button_seat_2,
                    # home
                    ...
                    self.h5_home_button_max,self.h5_home_button_seat_1,self.h5_home_button_seat_2,
                    # fan
        ...
        bottom_buttons = [self.button_fan, self.button_AC, self.button_max, self.button_hazard, self.button_audio,
                          ...
                          self.h5_fan_button_hazard,
                          self.h5_fan_button_max,
                          self.button_seat_1, self.button_seat_2,
                          self.h5_wiper_button_seat_1, self.h5_wiper_button_seat_2,
                          self.h5_light_button_seat_1, self.h5_light_button_seat_2,
                          self.h5_home_button_seat_1, self.h5_home_button_seat_2,
                          ]
