...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # LOGS
        self.fan_logo_button.clicked.connect(lambda: self.log_button_click("Missed Click"))  # Log clicks
        ...
        self.h4_climate_button_auto.clicked.connect(lambda: self.log_button_click("Auto Climate"))
